...
public class Army implements JSONSerializable{
	...
	public void toJSON(PrintWriter writer) {
		writer.print("{");
		boardTroops.toJSON(writer); writer.print(",");
		writer.print("\"stack\":["); listToJSON(writer, stack);
		writer.print(",\"captured\":["); listToJSON(writer, captured);
		writer.print("}");
	}
